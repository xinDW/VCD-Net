...
label                             = 'bead_40x_[m30-30]_step1um_sparse'                  # Distingiushable label for saving the checkpoint files and validation result
# label                             = 'rbcDSRED_20x_n11_[m50-50]_step2um_sparse'
config.label                      = label     


## Training 
config.TRAIN.target3d_path        = 'example_data/train/bead/[m30-30]step1um/WF/'   # 3-D targets for training
config.TRAIN.lf2d_path            = 'example_data/train/bead/[m30-30]step1um/LF/'  # LF projections for training
...
## Inference
config.VALID.lf2d_path            = 'example_data/valid/bead/'                           # location of LF measurements (Nnum = 11) to be reconstructed
