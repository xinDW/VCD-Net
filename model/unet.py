...
from tensorlayer.layers import InputLayer, SubpixelConv2d, ConcatLayer, UpSampling2dLayer
...
def UNet_A(lf_extra, n_slices, output_size, is_train=True, reuse=False, name='unet'):
    ...
    with tf.variable_scope(name, reuse=reuse):
        ...
        with tf.variable_scope('decoder'):
            ...
            n = UpSampling2dLayer(n,size=(h, w),is_scale=False, name = 'upsamplimg')
            ...
            for idx in range(nl - 1, -1, -1): # idx = 4,3,2,1,0
                ...
                n = UpSampling2dLayer(n,size=out_size,is_scale=False, name = 'upsamplimg%d' % (nl - idx + 1))
